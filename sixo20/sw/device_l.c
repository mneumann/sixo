...
*
* History: 11.02.2004 Changed the settings CNTRxxxx for Rx/Tx control register.
*                     CTS/RTS has been disabled since P60 and P64 are used as
*                     LCD_CS1 and LCD_RST (SIxO 2.0).
*******************************************************************************/
...
/* ===================================================================
   UART CALCULATIONS FOR M16C UART 0/1/2
...
#define BRG(UARTCLK,UARTPRESCL) ((FSYS / (UARTCLK * UARTPRESCL * 16L)) - 1L)

#define U0BRG ((FSYS / (U0CLK * U0PRESCL * 16L)) - 1L)
#define U1BRG ((FSYS / (U1CLK * U1PRESCL * 16L)) - 1L)
#define U2BRG ((FSYS / (U2CLK * U2PRESCL * 16L)) - 1L)
    ...
    #define BRG96       BRG(9600,1)
    #define CNTR96      0x10   /* f1   */
    #define BRG48       BRG(4800,1)
    #define CNTR48      0x10   /* f1   */
    #define BRG24       BRG(2400,8)
    #define CNTR24      0x11   /* f8   */
    #define BRG12       BRG(1200,8)
    #define CNTR12      0x11   /* f8   */
#else // SIXO10
    /* uart speed settings */
