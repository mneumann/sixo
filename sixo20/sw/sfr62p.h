...
/* !!! ACHTUNG !!!
   ...
   Die nachfolgenden zeilen sind normalerweise NICHT mehr enthalten 
   und wurden aus der alten Original sfr62.h entnommen.
   Was bedeutet 'us "MOV"? Zugriff so nicht erlaubt????     */
