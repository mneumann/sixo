 ...
 *                  The hardware may deliver wrong values. This is likely to
 *                  occur after the very first power up or when the Li-Battery
 *                  is replaced from the RTC.
 *                  The software in the upper layers must be robust enough
 *                  to handle wrong time and date values.
 *********************************************************************** */
