 ...
 *  Project:        SIxO
 *  Module:         debug
 *  Purpose:        debgug out to uart0/1
 *  Comments:       -
 *                  if MINIEMU is defined, debug out is given to
...
ERRCODE DebugInitHW(void)
{
    ...
    /* port 6 */
#ifdef MINIEMU
    pd6_0 = PIN_OUT;    /* uart0 CTS */
    pd6_1 = PIN_OUT;    /* uart0 CLK */
    pd6_2 = PIN_IN;     /* uart0 RXD */
    pd6_3 = PIN_OUT;    /* uart0 TXD */
#else
    pd6_4 = PIN_OUT;    /* uart1 CTS */
    pd6_5 = PIN_OUT;    /* uart1 CLK */
    pd6_6 = PIN_IN;     /* uart1 RXD */
    pd6_7 = PIN_OUT;    /* uart1 TXD */
#endif
#endif
    return ERR_OK;
}
